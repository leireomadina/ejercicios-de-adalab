...
function addImage (event) {
  ...
  //comprobamos el value del option seleccionado y modificamos la src de la img correspondiente
    if (event.currentTarget.value === "Madrid") {
      newImage.src = "https://cdn.petitpalace.com/wp-content/uploads/2017/11/hoteles-petit-palace-en-madrid-max.jpg";
    } else if (event.currentTarget.value === "París") {
      newImage.src = "https://img.huffingtonpost.com/asset/5e1d9c4c2100003000af8d0c.jpeg?cache=5aaxY3NirQ&ops=scalefit_720_noupscale";
